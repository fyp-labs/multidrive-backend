import uuid
import enum
from sqlalchemy import Column, String, Integer, Boolean, Numeric, DateTime, Enum, JSON
...
class SubscriptionPlan(Base):
    ...
    tier = Column(Enum(SubscriptionTier, name="subscriptiontier"), nullable=False)
    action_limit = Column(Boolean, nullable=False)
    cycle = Column(Enum(SubscriptionCycle, name="subscriptioncycle"), nullable=False)
