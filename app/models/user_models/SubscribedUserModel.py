...
class SubscribedUser(Base):
    ...
    connected_email_accounts = Column(Integer, nullable=False, server_default="0")
    connected_cloud_accounts = Column(Integer, nullable=False, server_default="0")
    connected_social_accounts = Column(Integer, nullable=False, server_default="0")
